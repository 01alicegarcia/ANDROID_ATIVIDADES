            ...
            if (palpite.isNotEmpty()) {
                ...
                when {
                    palpiteInt < numeroAleatorio -> {
                        txtResultado.text = "Hum... certeza? Seu palpite é muito baixo."
                    }
                    palpiteInt > numeroAleatorio -> {
                        txtResultado.text = "Hum... pense de novo! Seu palpite é muito alto."
                    }
                    else -> {
                        txtResultado.text = "Olha só, meus parabéns! Você acertou!."
                    }
                }
            } else {
                txtResultado.text = "Por gentileza, insira um bom palpite!."
            }
        }
